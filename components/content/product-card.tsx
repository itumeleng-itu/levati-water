    ...
    >
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <div className="mt-6 flex justify-end">
          {/* Stretched link (spec §5): the card's whole surface is clickable
              via this pseudo-element, while the button itself stays the one
              real focusable control for keyboard users. */}
          <Button
